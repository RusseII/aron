...
class DBClient:
    ...
    def __init__(self):
        ...
        self.mongo_client = MongoClient(
            'mongodb+srv://admin:' + os.environ.get('MONGODB_PASS') + '@c0.relki.mongodb.net')
    ...
    def inputMessage(self, username, contents, thedatetime, streamer):
        ...
        messageDocument = {"username": username, "contents": contents, "datetime": str(
            thedatetime), "streamer": streamer}
    ...
    def recreate_db(self):
        ...
        messageDocument = {"username": "testUser", "contents": "I am posting a new message", "datetime": str(
            datetime.datetime.now()), "streamer": "teststreamer"}
    ...
    def analyzeStream(self, streamer):
        ...
        # open videofile and read length
        duration_in_seconds = 0
        with (''.join([streamer_output_file_location, streamer, '.mkv'])) as clip:
            duration_in_seconds = clip.duration
        ...
        for x in range(minutes):
            ...
            if(results.count() > 0):
                ...
                total_data.append({'start_time': output_start_time, 'end_time': output_end_time,
                                   'messeges_count': results.count(), 'source_clip': streamer})
